import{j as v}from"./jsx-runtime-D_zvdyIk.js";import{e as T,r as _}from"./index-B3j06Xw8.js";const P="_bordered_1blpv_18",H="_left_1blpv_40",I="_center_1blpv_43",k="_right_1blpv_46",u={"f-table-component":"_f-table-component_1blpv_1","f-table-component__table":"_f-table-component__table_1blpv_7",bordered:P,"bordered-half":"_bordered-half_1blpv_22","f-table-component__table_header":"_f-table-component__table_header_1blpv_25","is-sticky":"_is-sticky_1blpv_29","f-table-component__table_header-cell":"_f-table-component__table_header-cell_1blpv_37",left:H,center:I,right:k,"f-table-component__table_body":"_f-table-component__table_body_1blpv_65","f-table-component__table_row":"_f-table-component__table_row_1blpv_68","f-table-component__table_row_no-hover":"_f-table-component__table_row_no-hover_1blpv_68","f-table-component__table_body-cell":"_f-table-component__table_body-cell_1blpv_81","f-table-component__table_footer":"_f-table-component__table_footer_1blpv_97"},j=({st:m,children:l,textAlignment:a="left",isSticky:r=!0,...c})=>v.jsx("thead",{style:m,...c,className:`${u["f-table-component__table_header"]} ${r?u["is-sticky"]:""} ${c.className||""} ${u[a]}`,children:l});j.__docgenInfo={description:`Компонент FTableHead представляет собой заголовок таблицы (\`<thead>\`).\r
...
@type {boolean}\r
@default false`,defaultValue:{value:"true",computed:!1}}}};const E=({st:m,children:l,textAlignment:a="left",tableWrapperRef:r,visibleRowCount:c=void 0,...y})=>{const f=_.useRef(null),o=_.useMemo(()=>T.Children.toArray(l),[l]),g=o.length,[h,p]=_.useState(0),[e,S]=_.useState(Array(o.length).fill(0)),b=typeof c=="number"&&c>0;_.useEffect(()=>{e.length<o.length&&S(n=>[...n,...Array(o.length-n.length).fill(0)])},[o.length,e.length]);const R=_.useCallback(()=>{if(!b||!(r!=null&&r.current)||!f.current)return;const s=r.current.scrollTop;let d=0,i=0;for(let t=0;t<e.length;t++){if(d+e[t]>s){i=t;break}d+=e[t]}p(i)},[e,r,b]),w=_.useCallback(()=>{b&&requestAnimationFrame(R)},[R,b]);_.useEffect(()=>{var s;if(!b)return;const n=()=>requestAnimationFrame(R);return window.addEventListener("resize",n),(s=r==null?void 0:r.current)==null||s.addEventListener("scroll",w),n(),()=>{var d;window.removeEventListener("resize",n),(d=r==null?void 0:r.current)==null||d.removeEventListener("scroll",w)}},[w,R,b]),_.useLayoutEffect(()=>{if(!f.current)return;const n=f.current.querySelectorAll("tr[data-row-index]"),s=[...e];let d=!1;n.forEach((i,t)=>{const q=b?h+t:t,C=i.getBoundingClientRect().height;C>0&&s[q]!==C&&(s[q]=C,d=!0)}),d&&S(s)},[o,e,h,b]);let F,N=0,x=0;if(b){let n=function(d,i){for(let t=d-1;t>=0;t--)if(i[t]>0)return i[t];for(let t=d+1;t<i.length;t++)if(i[t]>0)return i[t];return 0};const s=Math.min(h+c,g);F=o.slice(h,s),N=e.slice(0,h).reduce((d,i,t)=>d+(i>0?i:n(t,e)),0),x=e.slice(s).reduce((d,i,t)=>d+(i>0?i:n(s+t,e)),0)}else F=o;return v.jsxs("tbody",{ref:f,style:m,...y,className:`${u["f-table-component__table_body"]} ${y.className||""}  ${u[a]}`,children:[b&&e.some(n=>n>0)&&v.jsx("tr",{style:{height:N}}),F.map((n,s)=>T.isValidElement(n)?T.cloneElement(n,{"data-row-index":b?h+s:s,key:b?h+s:s}):n),b&&e.some(n=>n>0)&&v.jsx("tr",{style:{height:x}})]})},$=T.memo(E);E.__docgenInfo={description:`Компонент FTableBody представляет собой тело таблицы (\`<tbody>\`).\r
...
@type {React.RefObject<HTMLDivElement>}`},visibleRowCount:{required:!1,tsType:{name:"number"},description:"Количество видимых строк для виртуализации. Если не указано — виртуализация отключена.",defaultValue:{value:"undefined",computed:!0}}}};const A=({st:m,children:l,overflowX:a="auto",overflowY:r="auto",isSticky:c=!0,layout:y="auto",...f})=>{const o=_.useRef(null),[g,h]=_.useState(!1);return _.useEffect(()=>{const p=()=>{if(o.current&&c){const S=o.current.scrollTop>0;h(S)}},e=o.current;return e&&e.addEventListener("scroll",p),()=>{e&&e.removeEventListener("scroll",p)}},[]),v.jsx("div",{ref:o,className:u["f-table-component"],style:{overflowX:a,overflowY:r},children:v.jsx("table",{style:{...m,tableLayout:y},...f,className:`table ${u["f-table-component__table"]} ${u.bordered} ${u["bordered-half"]} ${f.className||""}`,children:T.Children.map(l,p=>{if(T.isValidElement(p)&&p.type===j){const e=p.props;return T.cloneElement(p,{...e,isSticky:g})}if(T.isValidElement(p)&&p.type===$){const e=p.props;return T.cloneElement(p,{...e,tableWrapperRef:o})}return p})})})};A.__docgenInfo={description:`Компонент FTable представляет собой таблицу с возможностью управления переполнением и "липким" заголовком.\r
...
@type {"auto" | "fixed"}\r
@default "auto"`,defaultValue:{value:'"auto"',computed:!1}}}};const V=({st:m,children:l,textAlignment:a,disableHover:r=!1,...c})=>{const y=[u["f-table-component__table_row"],c.className||""];return r&&y.push(u["f-table-component__table_row_no-hover"]),a!==void 0&&y.push(u[a]),v.jsx("tr",{style:m,...c,className:y.join(" ").trim(),children:l})};V.__docgenInfo={description:`Компонент FTableRow представляет собой строку таблицы (\`<tr>\`).\r
...
@type {boolean}\r
@default false`,defaultValue:{value:"false",computed:!1}}}};const L=({st:m,row:l,col:a,children:r,textAlignment:c,width:y="auto",...f})=>{const o={textAlign:c,width:y,...m};return v.jsx("th",{rowSpan:l&&l>1?l:void 0,colSpan:a&&a>1?a:void 0,...f,className:`${u["f-table-component__table_header-cell"]} ${f.className||""}`,style:o,children:r})};L.__docgenInfo={description:`Компонент FTableHeaderCell представляет собой ячейку заголовка таблицы (\`<th>\`).\r
...
@default 'auto'`,defaultValue:{value:"'auto'",computed:!1}}}};const B=({st:m,row:l,col:a,children:r,textAlignment:c,height:y="auto",...f})=>{const o={textAlign:c,height:y,...m};return v.jsx("td",{rowSpan:l&&l>1?l:void 0,colSpan:a&&a>1?a:void 0,...f,className:`${u["f-table-component__table_body-cell"]} ${f.className||""}`,style:o,children:r})};B.__docgenInfo={description:`Компонент FTableDataCell представляет собой ячейку данных таблицы (\`<td>\`).\r
...
@type {number | string}\r
@default 'auto'`,defaultValue:{value:"'auto'",computed:!1}}}};const D=({st:m,children:l,...a})=>v.jsx("tfoot",{style:m,...a,className:`${u["f-table-component__table_footer"]} ${a.className||""}`,children:l});D.__docgenInfo={description:`Компонент FTableFooter представляет собой нижний колонтитул таблицы (\`<tfoot>\`).\r
Он поддерживает настройку стилей и передачу дочерних элементов.\r
\r
@component\r
@example\r
