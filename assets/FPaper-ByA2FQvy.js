import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as c}from"./index-DEgj3Fem.js";const u="_panel_yplsg_1",n={panel:u,"panel-default":"_panel-default_yplsg_6","panel-heading":"_panel-heading_yplsg_12","panel-body":"_panel-body_yplsg_24","portlet-body":"_portlet-body_yplsg_29","panel-title":"_panel-title_yplsg_29","panel-group":"_panel-group_yplsg_30","panel-group-accordion":"_panel-group-accordion_yplsg_30","form-title":"_form-title_yplsg_31"},g=({label:r,children:i,st:s,fontSizeLabel:p,fontSizeBody:l,id:o,className:d,onAnimationEnd:m,animated:e})=>(c.useEffect(()=>{if(e){const t=document.getElementsByClassName(`animated-${e.name}`)[0];t&&t.setAttribute(e.name,e.value)}},[e]),a.jsxs("div",{className:`${n.panel} ${n["panel-default"]} ${d||""} ${e?`${n[`animated-${e.name}`]} ${e.name}`:""}`,style:s,id:o,onAnimationEnd:m,children:[r&&a.jsx("div",{className:n["panel-heading"],children:a.jsx("h3",{className:n["panel-title"],style:{fontSize:p},children:r})}),a.jsx("div",{className:n["panel-body"],style:{fontSize:l},children:i})]}));g.__docgenInfo={description:`Компонент \`FPaper\` — универсальная панель с поддержкой:\r
- заголовка (\`label\`)\r
