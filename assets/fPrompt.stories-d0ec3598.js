import{a as e}from"./jsx-runtime-03b4ddbf.js";/* empty css                  */import{f as n}from"./fAlert-f7923c5f.js";import{F as f}from"./FStack-e49fc9aa.js";import{F as d}from"./FButton-e5c79c89.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";/* empty css               */function m(t){return t?t.value:null}const v=({title:t,body:s})=>new Promise(r=>{window.document.body.insertAdjacentHTML("afterbegin",`
        ...
        `);let l=document.querySelector("#f-function-prompt-ok"),p=document.querySelector("#f-function-prompt-cancellation"),u=document.querySelector("#f-function-prompt-input");l.addEventListener("click",function(){r(m(u))}),p.addEventListener("click",function(){r(null)})}),L={title:"Function Elements/fPrompt",tags:["autodocs"]},o=()=>e(f,{spacing:2,direction:"row",children:e(d,{color:"primary",onClick:async()=>{const t=await v({title:"Вам нравится работа в РосНИИВХ?",body:'Думаю вы понимаете почему нельзя отвечать "НЕТ"'});t!==null&&t.toLowerCase()==="нет"?n({body:"Ты сделал не верный выбор и за тобой уже выехали",variant:"error"}):t!==null&&t.toLowerCase()==="да"?n({body:"Ситх, ты выбрал правильную, темную, сторону",variant:"success"}):n({body:`Не бойся, мы же оба знаем правильный ответ
Попробуй снова!`,variant:"info"})},children:"Ответить на главный вопрос жизни"})});var i,a,c;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`() => <FStack spacing={2} direction={'row'}>
    ...
    </FStack>`,...(c=(a=o.parameters)==null?void 0:a.docs)==null?void 0:c.source}}};const C=["Default"];export{o as Default,C as __namedExportsOrder,L as default};
//# sourceMappingURL=fPrompt.stories-d0ec3598.js.map
