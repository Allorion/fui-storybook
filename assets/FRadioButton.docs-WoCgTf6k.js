...
`,e.jsx(d.pre,{children:e.jsx(d.code,{children:`<FRadioButton label="Выбрать" checked={isChecked} onClick={() => setIsChecked(!isChecked)} />

<FRadioButton label="Отключено" disabled />
...
`]})]})}function f(i={}){const{wrapper:d}={...s(),...i.components};return d?e.jsx(d,{...i,children:e.jsx(l,{...i})}):l(i)}export{f as default};
