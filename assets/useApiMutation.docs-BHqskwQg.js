...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-tsx",children:`import { useApiMutation } from "@your-org/ui-kit";\r
\r
...
export const CreateUserForm = () => {\r
  const { mutate, isPending } = useApiMutation<\r
    IUserResponse,\r
...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-ts",children:`const mutation = useApiMutation<TQueryFnData, TVariables>(\r
  url,\r
  config?,\r
  options?\r
);
...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-tsx",children:`const { mutateAsync, isPending } = useApiMutation<void, IRolePayload>(\r
...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-tsx",children:`const { mutate, isPending } = useApiMutation<IUploadResponse>(\r
...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-tsx",children:`const ModalForm = ({ onClose }: { onClose: () => void }) => {\r
  const { mutateAsync, isPending } = useApiMutation("/api/v1/categories");\r
\r
