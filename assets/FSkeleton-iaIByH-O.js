import{j as f}from"./jsx-runtime-D_zvdyIk.js";import{r as i}from"./index-B3j06Xw8.js";const y="_skeleton_3ica6_1",d={"skeleton-block":"_skeleton-block_3ica6_1",skeleton:y},g=({children:p,enable:c,width:u,height:m})=>{const a=i.useRef(null),o=i.useRef([]),s=i.useRef([]),h=n=>{const t=document.createElement("div");t.className=d.skeleton;const e=window.getComputedStyle(n);return t.style.width=u??e.width,t.style.height=m??e.height,t.style.borderRadius=e.borderRadius==="0px"?"10px":e.borderRadius,t.style.margin=e.margin,t.style.display=e.display||"block",t.style.position=e.position||"relative",t},k=()=>{const n=a.current;if(!n)return;const t=Array.from(n.children);o.current=[],s.current=[],t.forEach(e=>{const r=h(e);o.current.push(e),s.current.push(r),e.parentNode&&e.parentNode.replaceChild(r,e)})},l=()=>{a.current&&(o.current.forEach((t,e)=>{const r=s.current[e];r&&t&&r.parentNode&&r.parentNode.replaceChild(t,r)}),s.current=[],o.current=[])};return i.useEffect(()=>(c?k():l(),()=>{l()}),[c]),f.jsx("div",{ref:a,className:d["skeleton-block"],children:p})};g.__docgenInfo={description:`Компонент \`FSkeleton\` — временная заглушка вместо контента во время загрузки.\r
\r
@component\r
@example\r
