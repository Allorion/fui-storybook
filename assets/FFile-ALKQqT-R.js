import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{F as l}from"./FTrashIcon-DpmD7QBY.js";const d="_progressBar_1iwax_48",m="_completed_1iwax_60",c="_progress_1iwax_48",r={"file-preview-card":"_file-preview-card_1iwax_1","file-preview-info":"_file-preview-info_1iwax_22","file-preview-name":"_file-preview-name_1iwax_28","file-preview-size":"_file-preview-size_1iwax_36","trash-icon":"_trash-icon_1iwax_42",progressBar:d,completed:m,progress:c},f=({id:t,className:p,st:o,handleDelete:i,name:s,size:a,progress:n})=>e.jsxs("div",{className:`${r["file-preview-card"]} ${p||""}`,id:t,style:o,children:[e.jsxs("div",{className:r["file-preview-info"],children:[e.jsx("span",{className:r["file-preview-name"],title:s,children:s}),typeof a=="number"&&e.jsxs("span",{className:r["file-preview-size"],children:[Math.round(a/1024)," КБ"]})]}),i&&e.jsx("div",{className:r["trash-icon"],children:e.jsx(l,{size:20,color:"danger",handleClick:i})}),typeof n=="number"&&e.jsx("div",{className:`${r.progressBar} ${n===100?r.completed:""}`,children:e.jsx("div",{className:r.progress,style:{width:`${n}%`}})})]});f.__docgenInfo={description:`Компонент \`FFile\` — отображает карточку одного файла с возможностью удаления\r
