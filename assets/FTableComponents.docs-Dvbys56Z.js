import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as s}from"./index-BoUPaUI-.js";import"./index-Dk76avTK.js";import{M as n}from"./index-D2FjQfgL.js";import"./index-B3j06Xw8.js";import"./preview-GcN2hVsk.js";import"./iframe--RpRLEhy.js";import"./DocsRenderer-CFRXHY34-Cujdgjng.js";import"./client-DOawrHdJ.js";import"./index-DW0t0JKo.js";import"./index-D_ywfbVi.js";import"./index-DgH-xKnr.js";import"./index-Bhqu_tAV.js";function r(l){const d={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(n,{title:"Material/FTableComponents"}),`
...
`,e.jsx("b",{children:"По умолчанию:"}),' "auto"']})})]})]})]}),`
...
`,e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:"15px"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{background:"#f5f5f5"},children:[e.jsx("th",{style:{padding:"8px",border:"1px solid #e0e0e0",textAlign:"left"},children:e.jsx(d.p,{children:"Проп"})}),e.jsx("th",{style:{padding:"8px",border:"1px solid #e0e0e0",textAlign:"left"},children:e.jsx(d.p,{children:"Тип"})}),e.jsx("th",{style:{padding:"8px",border:"1px solid #e0e0e0",textAlign:"left"},children:e.jsx(d.p,{children:"Описание"})})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"children"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"React.ReactNode"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Контент ячейки заголовка"})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"className"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Кастомный CSS класс"})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"st"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"React.CSSProperties"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Инлайновые стили"})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"row"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"number"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Значение rowspan для объединения строк."})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"col"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"number"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Значение colspan для объединения столбцов."})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"textAlignment"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"'left' | 'right' | 'center' | 'justify'"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsxs(d.p,{children:["Выравнивание текста внутри ячейки. ",e.jsx("b",{children:"По умолчанию:"})," 'left'"]})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"width"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"number | string"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsxs(d.p,{children:["Ширина ячейки. ",e.jsx("b",{children:"По умолчанию:"})," 'auto'"]})})]})]})]}),`
`,e.jsx(d.h3,{id:"ftabledatacell",children:"FTableDataCell"}),`
`,e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:"15px"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{background:"#f5f5f5"},children:[e.jsx("th",{style:{padding:"8px",border:"1px solid #e0e0e0",textAlign:"left"},children:e.jsx(d.p,{children:"Проп"})}),e.jsx("th",{style:{padding:"8px",border:"1px solid #e0e0e0",textAlign:"left"},children:e.jsx(d.p,{children:"Тип"})}),e.jsx("th",{style:{padding:"8px",border:"1px solid #e0e0e0",textAlign:"left"},children:e.jsx(d.p,{children:"Описание"})})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"children"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"React.ReactNode"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Контент ячейки данных"})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"className"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Кастомный CSS класс"})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"st"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"React.CSSProperties"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Инлайновые стили"})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"row"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"number"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Значение rowspan для объединения строк."})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"col"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"number"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Значение colspan для объединения столбцов."})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"textAlignment"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"'left' | 'right' | 'center' | 'justify'"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsxs(d.p,{children:["Выравнивание текста внутри ячейки. ",e.jsx("b",{children:"По умолчанию:"})," 'left'"]})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"height"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx("code",{children:"number | string"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsxs(d.p,{children:["Высота ячейки. ",e.jsx("b",{children:"По умолчанию:"})," 'auto'"]})})]})]})]}),`
...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-tsx",children:`import { FTable, FTableBody, FTableRow, FTableDataCell, FTableActions } from 'fui-material';

<FTable layout="fixed">
  <FTableBody truncateAt={60}>
    <FTableRow>
      <FTableDataCell>{description}</FTableDataCell>
      <FTableDataCell truncate={false}>{registrationNumber}</FTableDataCell>
      <FTableDataCell>
        <FTableActions aria-label="Действия с записью">
          <button type="button" onClick={edit}>Редактировать</button>
          <hr />
          <button type="button" data-danger onClick={remove}>Удалить</button>
        </FTableActions>
      </FTableDataCell>
    </FTableRow>
  </FTableBody>
...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-tsx",children:`<FTable searchable>
  <FTableHead>
    <FTableRow>
      <FTableHeaderCell sortKey="name">Название</FTableHeaderCell>
      <FTableHeaderCell sortKey="amount">Сумма</FTableHeaderCell>
      <FTableHeaderCell sortKey="date">Дата</FTableHeaderCell>
    </FTableRow>
  </FTableHead>
  <FTableBody visibleRowCount={30}>
    {items.map(item => (
      <FTableRow key={item.id}>
        <FTableDataCell sortKey="name">{item.name}</FTableDataCell>
        <FTableDataCell sortKey="amount" sortValue={item.amount}>
          {item.amount.toLocaleString('ru-RU')} ₽
        </FTableDataCell>
        <FTableDataCell sortKey="date" sortValue={item.timestamp}>
          {item.formattedDate}
        </FTableDataCell>
      </FTableRow>
    ))}
...
`})}),`
`,e.jsxs(d.p,{children:[`| Компонент | Проп | Поведение |
| --- | --- | --- |
| `,e.jsx(d.code,{children:"FTable"})," | ",e.jsx(d.code,{children:"searchable?: boolean"})," | Показывает поиск над таблицей. По умолчанию ",e.jsx(d.code,{children:"false"}),`; кнопки фильтров нет. |
| `,e.jsx(d.code,{children:"FTableHeaderCell"})," | ",e.jsx(d.code,{children:"sortKey?: string"}),` | Непустой ключ включает сортировку по соответствующим ячейкам. Без ключа заголовок обычный. |
| `,e.jsx(d.code,{children:"FTableDataCell"})," | ",e.jsx(d.code,{children:"sortKey?: string"}),` | Совпадает с ключом заголовка, включая многоуровневую шапку. |
| `,e.jsx(d.code,{children:"FTableDataCell"})," | ",e.jsx(d.code,{children:"sortValue?: string \\| number"}),` | Значение сортировки вместо текста: число для сумм, timestamp для дат, строка для названий. |
...
`,e.jsxs(d.p,{children:[e.jsx(d.code,{children:"row={2}"})," означает HTML ",e.jsx(d.code,{children:"rowSpan={2}"}),`: ячейка занимает текущую и следующую строки.
Для двух самостоятельных записей передавайте все ячейки в каждой строке `,e.jsxs(d.strong,{children:["без ",e.jsx(d.code,{children:"row={2}"})]}),`.
...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-tsx",children:`<FTableBody>
  <FTableRow>
    <FTableDataCell row={2}>1</FTableDataCell>
    <FTableDataCell row={2}><FTableActions><button>Редактировать</button></FTableActions></FTableDataCell>
    <FTableDataCell row={2}>Регистрационный номер</FTableDataCell>
    <FTableDataCell>Проект</FTableDataCell>
    <FTableDataCell>Первый участок</FTableDataCell>
  </FTableRow>
  <FTableRow>
    <FTableDataCell>Проект</FTableDataCell>
    <FTableDataCell>Второй участок</FTableDataCell>
  </FTableRow>
</FTableBody>
`})}),`
