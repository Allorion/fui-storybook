...
`,e.jsxs(r.p,{children:[e.jsx(r.code,{children:"LibraryProvider"}),' служит "мостом" (адаптером) между вашим приложением и хуками библиотеки (',e.jsx(r.code,{children:"useApiQuery"}),", ",e.jsx(r.code,{children:"useManualApiQuery"}),", ",e.jsx(r.code,{children:"useApiMutation"}),")."]}),`
...
test("тестирование хука", () => {\r
  const { result } = renderHook(() => useApiQuery(["key"], "/api"), {\r
    wrapper,\r
  });\r
  // ...\r
});
...
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:"Причина:"})," Один из хуков (",e.jsx(r.code,{children:"useApiQuery"}),", ",e.jsx(r.code,{children:"useManualApiQuery"}),", ",e.jsx(r.code,{children:"useApiMutation"}),") был вызван в компоненте, который находится ВНЕ дерева ",e.jsx(r.code,{children:"<LibraryProvider>"}),"."]}),`
