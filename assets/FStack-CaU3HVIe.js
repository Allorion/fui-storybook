import{j as m}from"./jsx-runtime-Cf8x2fCZ.js";const d=({children:r,alignItems:a,justifyContent:t,direction:l="column",wrap:i,spacing:s=0,className:p,st:n,id:c})=>{let e={gap:`${+s*8}px`,display:"flex",flexDirection:l,justifyContent:t,alignItems:a,flexWrap:i};return n!==void 0&&(e=Object.assign(e,n)),m.jsx("div",{className:p,style:e,id:c,children:r})};d.__docgenInfo={description:`Компонент \`FStack\` — гибкий контейнер с возможностью управления расположением дочерних элементов.\r
\r
