import{j as i}from"./jsx-runtime-Cf8x2fCZ.js";import{w as h,u as I}from"./index-CUyYkyAM.js";import"./index-yBjzXJbu.js";const n=({color:s="primary",size:c=30,st:t,id:k,className:F,handleClick:l,["data-testid"]:C})=>i.jsxs("svg",{width:c,viewBox:"0 0 24 24",className:`f-icon ${l?" clicking-icon":""} ${s} ${F||""}`,id:k,onClick:l,style:t,"data-testid":C,children:[i.jsx("path",{fill:"none",d:"M0 0h24v24H0z"}),i.jsx("path",{fillRule:"nonzero",d:"M14 14v6l-4 2v-8L4 5V3h16v2l-6 9zM6.404 5L12 13.394 17.596 5H6.404z"})]});n.__docgenInfo={description:`Компонент FFilterIcon представляет собой SVG иконку фильтра с возможностью настройки цвета, размера и обработки кликов.
