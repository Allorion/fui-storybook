import{j as T}from"./jsx-runtime-Cf8x2fCZ.js";import{e as R,r as h}from"./index-DY-snNUy.js";const P="_bordered_19x7r_18",$="_left_19x7r_40",H="_center_19x7r_43",I="_right_19x7r_46",m={"f-table-component":"_f-table-component_19x7r_1","f-table-component__table":"_f-table-component__table_19x7r_7",bordered:P,"bordered-half":"_bordered-half_19x7r_22","f-table-component__table_header":"_f-table-component__table_header_19x7r_25","is-sticky":"_is-sticky_19x7r_32","f-table-component__table_header-cell":"_f-table-component__table_header-cell_19x7r_37",left:$,center:H,right:I,"f-table-component__table_body":"_f-table-component__table_body_19x7r_65","f-table-component__table_row":"_f-table-component__table_row_19x7r_68","f-table-component__table_body-cell":"_f-table-component__table_body-cell_19x7r_81","f-table-component__table_footer":"_f-table-component__table_footer_19x7r_97"},E=({st:p,children:l,textAlignment:a="left",isSticky:e=!1,...f})=>T.jsx("thead",{style:p,...f,className:`${m["f-table-component__table_header"]} ${e?m["is-sticky"]:""} ${f.className||""} ${m[a]}`,children:l});E.__docgenInfo={description:`Компонент FTableHead представляет собой заголовок таблицы (\`<thead>\`).
...
@type {boolean}
@default false`,defaultValue:{value:"false",computed:!1}}}};const j=({st:p,children:l,textAlignment:a="left",tableWrapperRef:e,visibleRowCount:f=void 0,...y})=>{const _=h.useRef(null),c=h.useMemo(()=>R.Children.toArray(l),[l]),d=c.length,[o,S]=h.useState(0),[u,x]=h.useState(Array(c.length).fill(0)),b=typeof f=="number"&&f>0;h.useEffect(()=>{u.length<c.length&&x(n=>[...n,...Array(c.length-n.length).fill(0)])},[c.length,u.length]);const v=h.useCallback(()=>{if(!b||!(e!=null&&e.current)||!_.current)return;const r=e.current.scrollTop;let i=0,s=0;for(let t=0;t<u.length;t++){if(i+u[t]>r){s=t;break}i+=u[t]}S(s)},[u,e,b]),g=h.useCallback(()=>{b&&requestAnimationFrame(v)},[v,b]);h.useEffect(()=>{var r;if(!b)return;const n=()=>requestAnimationFrame(v);return window.addEventListener("resize",n),(r=e==null?void 0:e.current)==null||r.addEventListener("scroll",g),n(),()=>{var i;window.removeEventListener("resize",n),(i=e==null?void 0:e.current)==null||i.removeEventListener("scroll",g)}},[g,v,b]),h.useLayoutEffect(()=>{if(!_.current)return;const n=_.current.querySelectorAll("tr[data-row-index]"),r=[...u];let i=!1;n.forEach((s,t)=>{const q=b?o+t:t,F=s.getBoundingClientRect().height;F>0&&r[q]!==F&&(r[q]=F,i=!0)}),i&&x(r)},[c,u,o,b]);let w,C=0,N=0;if(b){let n=function(i,s){for(let t=i-1;t>=0;t--)if(s[t]>0)return s[t];for(let t=i+1;t<s.length;t++)if(s[t]>0)return s[t];return 0};const r=Math.min(o+f,d);w=c.slice(o,r),C=u.slice(0,o).reduce((i,s,t)=>i+(s>0?s:n(t,u)),0),N=u.slice(r).reduce((i,s,t)=>i+(s>0?s:n(r+t,u)),0)}else w=c;return T.jsxs("tbody",{ref:_,style:p,...y,className:`${m["f-table-component__table_body"]} ${y.className||""}  ${m[a]}`,children:[b&&u.some(n=>n>0)&&T.jsx("tr",{style:{height:C}}),w.map((n,r)=>R.isValidElement(n)?R.cloneElement(n,{"data-row-index":b?o+r:r,key:b?o+r:r}):n),b&&u.some(n=>n>0)&&T.jsx("tr",{style:{height:N}})]})},k=R.memo(j);j.__docgenInfo={description:`Компонент FTableBody представляет собой тело таблицы (\`<tbody>\`).
...
@type {React.CSSProperties}`},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Дочерние элементы (например, строки `<tr>` или ячейки `<td>`).\n@type {React.ReactNode}"}}};export{A as F,E as a,V as b,L as c,k as d,B as e,D as f};
