import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{r as x}from"./index-DY-snNUy.js";import{F as g}from"./FLoadIcon-Dfwkb_VK.js";const _={"f-text-field":"_f-text-field_200bb_1"},F=x.forwardRef(({label:r,type:o="text",fullWidth:d,errText:e,helpText:l,st:m,id:f,className:p,load:i=!1,height:u="auto",width:c,...s},b)=>{const y={...{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis",width:d?"100%":c||"fit-content",height:u||"auto"},...m},t=f||`input-${Math.random().toString(36).substring(2,9)}`;return n.jsxs("div",{className:`f-form-element ${_["f-text-field"]} ${p||""}`,style:y,role:"group",id:t+"-text-field-block","aria-labelledby":r?t+"-label":void 0,children:[r&&n.jsx("label",{id:t+"-label",htmlFor:t,className:`f-form-element__label ${e?"error":""}`,children:r}),n.jsxs("div",{className:`f-form-element__control ${i?"is-loading":""}`,children:[n.jsx("input",{ref:b,id:t,type:o,className:`f-form-element__control-element ${e?"error":""}`,"aria-invalid":!!e,"aria-describedby":[l?t+"-helptext":null,e!=null&&e.length?t+"-errortext":null].filter(Boolean).join(" "),...s,disabled:s.disabled||i}),i&&n.jsx("span",{className:"f-form-element__loader",children:n.jsx(g,{size:10})})]}),l&&n.jsx("p",{id:t+"-helptext",className:"f-form-element__helptext",children:l}),e&&e.length>0&&n.jsx("div",{className:"f-form-element__errorblock",children:e.map((h,a)=>n.jsx("p",{id:`${t}-errortext-${a}`,className:"f-form-element__errorblock_errortext",children:h},a))})]})});F.__docgenInfo={description:`Компонент FTextField представляет собой поле ввода с дополнительными функциями,
