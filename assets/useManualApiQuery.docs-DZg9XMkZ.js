...
`,e.jsx("code",{children:"useApiQuery"}),")"]})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Экспорта отчетов в разных форматах (Excel/PDF)"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsxs(d.p,{children:["Операций изменения данных без кэширования (используйте"," ",`\r
`,e.jsx("code",{children:"useApiMutation"}),")"]})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Поиска по запросу пользователя с POST-телом и кэшированием"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Простых запросов без динамических параметров"})})]})]})]}),`
`,e.jsx(d.hr,{}),`
...
\r
  ...
  const { run, data, isFetching } = useManualApiQuery<\r
    IOrder[],\r
    IOrder[],\r
    IFilterParams\r
