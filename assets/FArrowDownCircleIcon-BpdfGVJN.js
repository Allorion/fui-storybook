import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{e as p}from"./index-B3j06Xw8.js";const a=p.forwardRef(({color:n="primary",size:i=30,st:t,id:l,className:s,handleClick:e,["data-testid"]:o,...d},c)=>r.jsx("svg",{ref:c,width:i,style:t,className:`f-icon ${e?" clicking-icon":""} ${n} ${s||""}`,viewBox:"0 0 16 16",onClick:e,id:l,"data-testid":o,...d,children:r.jsx("path",{"fill-rule":"evenodd",d:"M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"})}));a.displayName="FArrowDownCircleIcon";a.__docgenInfo={description:`Компонент FArrowDownCircleIcon представляет собой SVG иконку стрелки влево в круге с возможностью настройки цвета, размера и обработки кликов.\r
\r
@function FArrowDownCircleIcon\r
@param {IFArrowDownCircleIcon} props - Пропсы компонента.\r
