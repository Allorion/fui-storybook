import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{r as x}from"./index-DY-snNUy.js";import{F as i}from"./FButton-C6QFu6NS.js";import{F as T}from"./FTrashIcon-BUKZ78xj.js";import{F as R}from"./FTextField-CvQDvwqw.js";const a={"f-search-box":"_f-search-box_1ce2j_1","f-search-box__input":"_f-search-box__input_1ce2j_7","f-search-box__button":"_f-search-box__button_1ce2j_13","f-search-box__button_search":"_f-search-box__button_search_1ce2j_19","clear-on":"_clear-on_1ce2j_23","f-search-box__button_clear":"_f-search-box__button_clear_1ce2j_26"},g=x.forwardRef(({label:n,fullWidth:c,disabled:t,readOnly:u,errText:p,helpText:d,load:l=!1,children:m,color:f="primary",variant:o="contained",onClickButton:y,clearDataFromInput:r,st:_,type:b,...s},h)=>e.jsxs("div",{className:`${a["f-search-box"]} form-group`,style:_,children:[e.jsx(R,{fullWidth:c,label:n,ref:h,disabled:t,readOnly:u||l,type:b??"text",helpText:d,errText:p,load:l,...s,className:`${a["f-search-box__input"]} ${s.className||""}`}),e.jsxs("div",{className:a["f-search-box__button"],style:{marginTop:n?"21.8px":"0"},children:[e.jsx(i,{className:`${a["f-search-box__button_search"]} ${r?a["clear-on"]:""}`,type:"button",disabled:t,onClick:y,color:f,variant:o,children:m}),r&&e.jsx(i,{className:`${a["f-search-box__button_clear"]}`,type:"button",onClick:r,color:"danger",variant:o,children:e.jsx(T,{color:"light",size:20})})]})]}));g.__docgenInfo={description:`Компонент \`FSearchBox\` — кастомное поле ввода с кнопкой справа и возможностью очистки.\r
\r
Поддерживает:\r
- метку (\`label\`)\r
