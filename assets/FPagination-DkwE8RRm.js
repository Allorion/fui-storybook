import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as S}from"./index-B3j06Xw8.js";const g="...",c=(n,l)=>{const r=l-n+1;return Array.from({length:r},(a,d)=>d+n)},b=({totalCount:n,pageSize:l,siblingCount:r=1,currentPage:a})=>S.useMemo(()=>{const t=Math.ceil(n/l);if(r*2+5>=t)return c(1,t);const f=Math.max(a-r,1),i=Math.min(a+r,t),u=f>2,p=i<t-2,_=1,m=t;if(!u&&p){const s=3+2*r;return[...c(1,s),g,t]}if(u&&!p){const s=3+2*r,y=c(t-s+1,t);return[_,g,...y]}if(u&&p){const s=c(f,i);return[_,g,...s,g,m]}return c(1,t)},[n,l,r,a]),x="_dots_uiqea_29",C="_selected_uiqea_33",P="_disabled_uiqea_37",q="_arrow_uiqea_43",$="_left_uiqea_56",e={"pagination-container":"_pagination-container_uiqea_1","pagination-item":"_pagination-item_uiqea_9",dots:x,selected:C,disabled:P,arrow:q,left:$},R=({currentPage:n,totalCount:l,pageSize:r,onPageChange:a,id:d,className:t,st:h,siblingCount:f})=>{const i=b({currentPage:n,totalCount:l,siblingCount:f,pageSize:r});if(n===0||!i||i.length<2)return null;const u=()=>a(n+1),p=()=>a(n-1),_=i[i.length-1];return o.jsxs("ul",{className:`${e["pagination-container"]} ${t||""}`,style:h,id:d,children:[o.jsx("li",{className:`${e["pagination-item"]} ${n===1?e.disabled:""}`,onClick:p,children:o.jsx("div",{className:`${e.arrow} ${e.left}`})}),i.map((m,s)=>m===g?o.jsx("li",{className:`${e["pagination-item"]} ${e.dots}`,children:"…"},s):o.jsx("li",{className:`${e["pagination-item"]} ${m===n?e.selected:""}`,onClick:()=>a(m),children:m},s)),o.jsx("li",{className:`${e["pagination-item"]} ${n===_?e.disabled:""}`,onClick:u,children:o.jsx("div",{className:`${e.arrow} ${e.right}`})})]})};R.__docgenInfo={description:`Компонент \`FPagination\` — горизонтальная навигация по страницам.\r
\r
Показывает:\r
