import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{r as t}from"./index-B3j06Xw8.js";import{r as U}from"./index-D_ywfbVi.js";import{F as Z}from"./FArrowIcon-e6BJPakw.js";import{F as ee}from"./FTextField-G4sFh9Uf.js";const te="_active_1h0yy_41",l={"f-select-search-db":"_f-select-search-db_1h0yy_1","f-select-search-db__input":"_f-select-search-db__input_1h0yy_7","f-select-search-db__input_field":"_f-select-search-db__input_field_1h0yy_11","f-select-search-db__input_arrow":"_f-select-search-db__input_arrow_1h0yy_14","f-select-search-db__dropdown":"_f-select-search-db__dropdown_1h0yy_21",active:te,"f-select-search-db__dropdown_content":"_f-select-search-db__dropdown_content_1h0yy_45"},ne=({fetchingFunc:F,selectedElement:R,selectItem:I,onChange:q,st:j,id:M,className:D,disabled:T,readOnly:C,fullWidth:P,label:H,onBlur:_,onFocus:O,errText:w,helpText:N,required:A,defaultValue:$,type:k,placeholder:z})=>{const[u,L]=t.useState($||""),[d,h]=t.useState([]),m=t.useRef(),[p,y]=t.useState(!1),[s,a]=t.useState(!1),[b,B]=t.useState("bottom"),o=t.useRef(null),E=t.useRef(null),c=t.useRef(null),[V,v]=t.useState(!1),[W,i]=t.useState(void 0);t.useEffect(()=>(c.current=document.createElement("div"),document.body.appendChild(c.current),()=>{const e=c.current;e&&e.parentNode===document.body&&document.body.removeChild(e)}),[]);const g=t.useCallback(()=>{if(!o.current||!E.current||!c.current)return;const e=o.current.getBoundingClientRect(),n=window.pageXOffset||document.documentElement.scrollLeft,f=window.pageYOffset||document.documentElement.scrollTop,S=4,K=e.top+f+(b==="bottom"?e.height-S:-E.current.offsetHeight-S),Q=e.left+n;Object.assign(c.current.style,{position:"absolute",top:`${K}px`,left:`${Q}px`,width:`${e.width}px`,zIndex:"9999"})},[b]);t.useEffect(()=>(s&&(g(),window.addEventListener("resize",g)),()=>{window.removeEventListener("resize",g)}),[s,g]);const x=()=>{if(!o.current)return;const e=o.current.getBoundingClientRect(),n=window.innerHeight-e.bottom,f=e.top;B(n>=200||n>=f?"bottom":"top")};t.useEffect(()=>(s&&(x(),window.addEventListener("resize",x)),()=>{window.removeEventListener("resize",x)}),[s]);const X=e=>{const n=e.target.value;q&&q(e),L(n),a(!1),v(!0),m.current&&clearTimeout(m.current),n.trim()!==""?m.current=setTimeout(async()=>{try{y(!0);const f=await F(n);h(f),f.length===0?(i(["- Данные не найдены"]),setTimeout(()=>i(void 0),3e3)):a(!0)}catch{i(["- Ошибка"]),setTimeout(()=>i(void 0),3e3)}finally{y(!1),v(!1)}},500):(R(null),h([]),a(!1),v(!1))},J=()=>{T||C||p||(s?a(!1):d.length>0?a(!0):u.trim()!==""&&G(u))},Y=e=>{R(e),L(I(e)),a(!1)};t.useEffect(()=>{const e=n=>{o.current&&!o.current.contains(n.target)&&a(!1)};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}},[]);const G=e=>{m.current&&clearTimeout(m.current),e!==""?m.current=setTimeout(async()=>{try{y(!0);const n=await F(e);h(n),n.length===0?(i(["- Данные не найдены"]),setTimeout(()=>i(void 0),3e3)):a(!0)}catch{i(["- Ошибка"]),setTimeout(()=>i(void 0),3e3)}finally{y(!1)}},3e3):h([])};return r.jsxs("div",{ref:o,className:`${l["f-select-search-db"]} ${D||""}`,style:j,id:M,"data-position":b,children:[r.jsxs("div",{className:l["f-select-search-db__input"],children:[r.jsx(ee,{fullWidth:P,readOnly:C||s,disabled:T||p,required:A,label:H,type:k,placeholder:z,className:l["f-select-search-db__input_field"],value:u,onChange:X,onFocus:O,onBlur:()=>{setTimeout(()=>{_==null||_(new Event("blur"))},100)},load:p,helpText:p?"Загрузка...":V?"После окончания ввода запрос отправится через 3 сек":N,errText:typeof w=="string"?[w]:w||W}),!p&&!T&&d.length>0&&r.jsx("div",{className:l["f-select-search-db__input_arrow"],style:{marginTop:H?"28px":"7px"},onClick:J,children:r.jsx(Z,{direction:s?"up":"down",size:15})})]}),s&&(d.length>0||u.trim()==="")&&c.current&&U.createPortal(r.jsx("div",{ref:E,className:`${l["f-select-search-db__dropdown"]} ${s?l.active:""}`,children:d.length===0&&u.trim()===""?r.jsx("li",{children:"Введите текст"}):d.length===0&&u.trim()!==""&&!p?r.jsx("li",{children:"Ничего не найдено"}):r.jsx("ul",{className:l["f-select-search-db__dropdown_content"],children:d.slice(0,10).map((e,n)=>r.jsx("li",{onMouseDown:()=>Y(e),children:I(e)},n))})}),c.current)]})};ne.__docgenInfo={description:`Компонент \`FSelectSearchDb\` — кастомное поле ввода с автопоиском по базе данных.\r
Поддерживает:\r
