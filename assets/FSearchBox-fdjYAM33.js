import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as x}from"./index-B3j06Xw8.js";import{F as c}from"./FButton-WshjMl_j.js";import{F as g}from"./FTrashIcon-DpmD7QBY.js";import{F as T}from"./FTextField-G4sFh9Uf.js";const n={"f-search-box":"_f-search-box_1s9ms_1","f-search-box__input":"_f-search-box__input_1s9ms_6","f-search-box__button":"_f-search-box__button_1s9ms_12","f-search-box__button_search":"_f-search-box__button_search_1s9ms_18","clear-on":"_clear-on_1s9ms_22","f-search-box__button_clear":"_f-search-box__button_clear_1s9ms_25"},R=x.forwardRef(({label:l,fullWidth:u,disabled:r,readOnly:p,errText:a,helpText:m,load:o=!1,children:d,color:f="primary",variant:s="contained",onClickButton:_,clearDataFromInput:t,st:y,type:b,...i},h)=>e.jsxs("div",{className:`${n["f-search-box"]} form-group`,style:y,children:[e.jsx(T,{fullWidth:u,label:l,ref:h,disabled:r,readOnly:p||o,type:b??"text",helpText:m,errText:typeof a=="string"?[a]:a,load:o,...i,className:`${n["f-search-box__input"]} ${i.className||""}`}),e.jsxs("div",{className:n["f-search-box__button"],style:{marginTop:l?"26px":"0"},children:[e.jsx(c,{className:`${n["f-search-box__button_search"]} ${t?n["clear-on"]:""} f-search-box__button_search-st`,type:"button",disabled:r,onClick:_,color:f,variant:s,children:d}),t&&e.jsx(c,{className:`${n["f-search-box__button_clear"]} f-search-box__button_clear-st`,type:"button",disabled:r,onClick:t,color:"danger",variant:s,children:e.jsx(g,{color:"light",size:20})})]})]}));R.__docgenInfo={description:`Компонент \`FSearchBox\` — кастомное поле ввода с кнопкой справа и возможностью очистки.\r
\r
Поддерживает:\r
- метку (\`label\`)\r
