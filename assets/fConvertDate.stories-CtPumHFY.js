...
\r
  ...
  action('Кастомный формат:')(result);
        ...
        Кастомный формат\r
    </FButton>`,...(g=(C=s.parameters)==null?void 0:C.docs)==null?void 0:g.source}}};const pt=["Default","CustomFormat"];export{s as CustomFormat,c as Default,pt as __namedExportsOrder,lt as default};
