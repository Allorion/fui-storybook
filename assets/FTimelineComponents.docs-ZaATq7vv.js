...
`,e.jsx(d.pre,{children:e.jsx(d.code,{className:"language-ts",children:`import FTimeline from './FTimeline';\r
import FTimelineCard from './FTimelineCard';\r
\r
<FTimeline>\r
  <FTimelineCard title="Старт">Начало процесса</FTimelineCard>\r
  <FTimelineCard title="Шаг 1">Описание первого шага</FTimelineCard>\r
  <FTimelineCard title="Шаг 2">Описание второго шага</FTimelineCard>\r
  <FTimelineCard title="Финиш">Завершение</FTimelineCard>\r
</FTimeline>
`})}),`
`,e.jsx(d.hr,{}),`
...
`]})]})}function T(i={}){const{wrapper:d}={...l(),...i.components};return d?e.jsx(d,{...i,children:e.jsx(r,{...i})}):r(i)}export{T as default};
