import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{r as t}from"./index-DY-snNUy.js";const f="_card_1pttw_1",R="_warning_1pttw_16",v="_info_1pttw_24",y="_alert_1pttw_32",r={card:f,warning:R,info:v,alert:y,"fv-accord-title":"_fv-accord-title_1pttw_57"},E=({variant:a="info",title:i,children:s,id:o,className:c,st:l,onClick:d,open:e,defaultOpen:p})=>{const[m,u]=t.useState(p);return t.useEffect(()=>{e!==void 0&&u(e)},[e]),n.jsx("div",{onClick:d,className:`${r.card} ${c||""}`,id:o,children:n.jsxs("details",{className:r[a],open:m,style:l,children:[n.jsx("summary",{className:r["fv-accord-title"],children:i}),s]})})};E.__docgenInfo={description:`Компонент \`FAccordion\` — простой аккордеон на основе HTML \`<details>\` и \`<summary>\`.\r
\r
Поддерживает:\r
