import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{e as V}from"./index-DEgj3Fem.js";import{within as w,userEvent as G}from"./index-CH2Su9EI.js";const t=V.forwardRef(({color:s="primary",size:c=30,st:n,id:k,className:F,handleClick:l,["data-testid"]:C,...h},I)=>i.jsxs("svg",{ref:I,width:c,viewBox:"0 0 24 24",className:`f-icon ${l?" clicking-icon":""} ${s} ${F||""}`,id:k,onClick:l,style:n,"data-testid":C,...h,children:[i.jsx("path",{fill:"none",d:"M0 0h24v24H0z"}),i.jsx("path",{fillRule:"nonzero",d:"M14 14v6l-4 2v-8L4 5V3h16v2l-6 9zM6.404 5L12 13.394 17.596 5H6.404z"})]}));t.displayName="FFilterIcon";t.__docgenInfo={description:`Компонент FFilterIcon представляет собой SVG иконку фильтра с возможностью настройки цвета, размера и обработки кликов.\r
\r
