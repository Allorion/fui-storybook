import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as c}from"./index-B3j06Xw8.js";const r=c.forwardRef(({color:n="primary",size:i=30,st:t,id:s,className:l,handleClick:a,["data-testid"]:d,...o},p)=>e.jsxs("svg",{ref:p,style:t,id:s,width:i,onClick:a,className:`f-icon ${a?" clicking-icon":""} ${n} ${l||""}`,viewBox:"0 0 16 16","data-testid":d,...o,children:[e.jsx("path",{d:"M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"}),e.jsx("path",{d:"M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708z"})]}));r.displayName="FUploadIcon";r.__docgenInfo={description:`Компонент FUploadIcon представляет собой SVG иконку загрузки на сервер с возможностью настройки цвета, размера и обработки кликов.\r
\r
@function FUploadIcon\r
@param {IFUploadIcon} props - Пропсы компонента.\r
