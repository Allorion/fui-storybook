import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{F as s}from"./FCloseIcon-DdRZhJBn.js";import{s as n}from"./FDialog-snE0jNMB.js";const i=({title:a,handleClose:e})=>r.jsxs("div",{className:n["f-dialog__header"],children:[r.jsx("h3",{className:n["f-dialog__header_title"],children:a}),e&&r.jsx("button",{type:"button",className:n["f-dialog__header_close"],onClick:e,"aria-label":"Закрыть диалог",children:r.jsx(s,{color:"secondary",size:18})})]});i.__docgenInfo={description:`Компонент \`FDialogHeader\` — шапка модального окна с заголовком и кнопкой закрытия.
