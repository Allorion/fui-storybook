...
`).map(r=>`<span>${r}</span>`),o="f-function-block-alert-"+U(),H=`
  ...
  </FButton>`,...(T=(N=d.parameters)==null?void 0:N.docs)==null?void 0:T.source}}};const Ht=["Info","Success","Error","Warning","NoTitle"];export{a as Error,s as Info,d as NoTitle,c as Success,l as Warning,Ht as __namedExportsOrder,Dt as default};
