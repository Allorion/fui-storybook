import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{w as I,u as w}from"./index-CUyYkyAM.js";import"./index-yBjzXJbu.js";const t=({color:s="primary",size:c=30,st:i,className:k,id:C,handleClick:l,["data-testid"]:h})=>n.jsxs("svg",{width:c,style:i,className:`f-icon ${l?" clicking-icon":""} ${s} ${k||""}`,viewBox:"0 0 16 16",onClick:l,id:C,"data-testid":h,children:[n.jsx("path",{d:"M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"}),n.jsx("path",{d:"M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8"})]});t.__docgenInfo={description:`Компонент FMinusIcon представляет собой SVG иконку минуса с возможностью настройки цвета, размера и обработки кликов.
...
@type {(() => void) | undefined}`},"data-testid":{required:!1,tsType:{name:"string"},description:"Data-testid для тестирования (опционально)"}}};const F={title:"Icons/FMinusIcon",tags:["autodocs"],component:t,argTypes:{color:{control:"select",options:["primary","secondary","success","danger","warning","info","light","dark","link"],description:"Цвет иконки. Определяет цветовую схему иконки"},size:{control:"number",description:"Размер иконки"},st:{control:"object",description:"Дополнительные стили для SVG элемента"},id:{control:"text",description:"Уникальный идентификатор для SVG элемента"},className:{control:"text",description:"Дополнительные CSS классы для SVG элемента"},handleClick:{action:"clicked",description:"Обработчик события клика по иконке"}},parameters:{docs:{description:{component:"Иконка минуса. Используйте для обозначения удаления или уменьшения количества объектов."}}}},o=s=>n.jsx(t,{...s}),a=o.bind({});a.args={handleClick:void 0};a.parameters={docs:{description:{story:"Базовая иконка без дополнительных свойств."}}};const e=o.bind({});e.args={handleClick:()=>alert("Иконка нажата!"),"data-testid":"icon-svg"};e.parameters={docs:{description:{story:"Иконка с обработчиком клика."}}};e.play=async({canvasElement:s})=>{const i=await I(s).findByTestId("icon-svg");await w.click(i)};const r=o.bind({});r.args={color:"warning",size:40,handleClick:void 0};r.parameters={docs:{description:{story:"Иконка с кастомным цветом и размером."}}};var d,p,m;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:"args => <FMinusIcon {...args} />",...(m=(p=a.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var u,g,y;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:"args => <FMinusIcon {...args} />",...(y=(g=e.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var f,S,v;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:"args => <FMinusIcon {...args} />",...(v=(S=r.parameters)==null?void 0:S.docs)==null?void 0:v.source}}};const G=["Default","Clickable","CustomColorAndSize"];export{e as Clickable,r as CustomColorAndSize,a as Default,G as __namedExportsOrder,F as default};
