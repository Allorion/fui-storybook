import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./index-B3j06Xw8.js";const f="_panel_d74rg_1",g="_compact_d74rg_29",n={panel:f,"panel-default":"_panel-default_d74rg_6","panel-heading":"_panel-heading_d74rg_12","panel-body":"_panel-body_d74rg_24",compact:g,"panel-title":"_panel-title_d74rg_40","portlet-body":"_portlet-body_d74rg_44","panel-group":"_panel-group_d74rg_45","panel-group-accordion":"_panel-group-accordion_d74rg_45","form-title":"_form-title_d74rg_46"},y=({label:r,children:i,st:s,fontSizeLabel:p,fontSizeBody:l,id:o,className:d,onAnimationEnd:c,animated:e,compact:m=!1})=>(u.useEffect(()=>{if(e){const t=document.getElementsByClassName(`animated-${e.name}`)[0];t&&t.setAttribute(e.name,e.value)}},[e]),a.jsxs("div",{className:`${n.panel} ${n["panel-default"]} ${m?n.compact:""} ${d||""} ${e?`${n[`animated-${e.name}`]} ${e.name}`:""}`,style:s,id:o,onAnimationEnd:c,children:[r&&a.jsx("div",{className:n["panel-heading"],children:a.jsx("h3",{className:n["panel-title"],style:{fontSize:p},children:r})}),a.jsx("div",{className:n["panel-body"],style:{fontSize:l},children:i})]}));y.__docgenInfo={description:`Компонент \`FPaper\` — универсальная панель с поддержкой:\r
- заголовка (\`label\`)\r
...
@default false`,defaultValue:{value:"false",computed:!1}}}};export{y as F};
