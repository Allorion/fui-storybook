import{j as i}from"./jsx-runtime-Cf8x2fCZ.js";import{r as l}from"./index-DY-snNUy.js";const c="_horizontal_zlvc7_1",d="_vertical_zlvc7_7",p="_active_zlvc7_50",a={"f-tabs":"_f-tabs_zlvc7_1",horizontal:c,vertical:d,"f-tabs__tab":"_f-tabs__tab_zlvc7_16",active:p},m=({children:r,id:t,className:n,st:e,orientation:s="horizontal"})=>i.jsx("div",{id:t,style:e,className:`${a["f-tabs"]} ${a[s]} ${n||""}`,children:r});m.__docgenInfo={description:`Компонент \`FTabs\` — контейнер для системы вкладок.\r
\r
