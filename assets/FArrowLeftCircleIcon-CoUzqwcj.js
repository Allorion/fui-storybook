import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{e as m}from"./index-B3j06Xw8.js";const a=m.forwardRef(({color:i="primary",size:n=30,st:t,id:l,className:s,handleClick:e,["data-testid"]:o,...d},c)=>r.jsx("svg",{ref:c,width:n,style:t,className:`f-icon ${e?" clicking-icon":""} ${i} ${s||""}`,viewBox:"0 0 16 16",onClick:e,id:l,"data-testid":o,...d,children:r.jsx("path",{"fill-rule":"evenodd",d:"M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5z"})}));a.displayName="FArrowLeftCircleIcon";a.__docgenInfo={description:`Компонент FArrowLeftCircleIcon представляет собой SVG иконку стрелки влево в круге с возможностью настройки цвета, размера и обработки кликов.\r
\r
@function FArrowLeftCircleIcon\r
@param {IFArrowLeftCircleIcon} props - Пропсы компонента.\r
