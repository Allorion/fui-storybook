import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{r as h}from"./index-DY-snNUy.js";import{F as y}from"./FLoadIcon-BM1DdYSY.js";const p={"f-select":"_f-select_1n6ag_1","f-select__control-element":"_f-select__control-element_1n6ag_5"},_=h.forwardRef(({label:r,st:s,children:i,fullWidth:o,load:a=!1,errText:e,helpText:l,height:c="auto",width:u="fit-content",id:f,...m},b)=>{const g=Object.assign({},{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis",width:o?"100%":u||"fit-content",height:c||"auto"},s),t=f||`input-${Math.random().toString(36).substring(2,9)}`;return n.jsxs("div",{className:`f-form-element ${p["f-select"]}`,style:g,id:t+"-select-block",role:"group","aria-labelledby":r?t+"-label":void 0,children:[r&&n.jsx("label",{id:t+"-label",htmlFor:t,className:`f-form-element__label ${e?"error":""}`,children:r}),n.jsxs("div",{className:`f-form-element__control ${a?"is-loading":""}`,children:[n.jsx("select",{ref:b,"aria-invalid":!!e,"aria-describedby":[l?t+"-helptext":null,e!=null&&e.length?t+"-errortext":null].filter(Boolean).join(" "),...m,id:t,disabled:m.disabled||a,className:`f-form-element__control-element ${p["f-select__control-element"]} ${e?"error":""} ${m.className||""}`,children:!a&&i}),a&&n.jsx("div",{className:"f-form-element__loader",children:n.jsx(y,{size:10})})]}),l&&n.jsx("p",{id:t+"-helptext",className:"f-form-element__helptext",children:l}),e&&e.length>0&&n.jsx("div",{className:"f-form-element__errorblock",children:e.map((S,d)=>n.jsx("p",{id:`${t}-errortext-${d}`,className:"f-form-element__errorblock_errortext",children:S},d))})]})});_.__docgenInfo={description:`Компонент \`FSelect\` — кастомное поле \`<select>\` с дополнительными возможностями:
...
@default 'auto'`,defaultValue:{value:'"auto"',computed:!1}},id:{required:!1,tsType:{name:"string"},description:"HTML ID элемента."}}};const R=({st:r,value:s,children:i,disabled:o,onClick:a,selected:e,className:l,id:c})=>n.jsx("option",{value:s,disabled:o,onClick:a,style:r,selected:e,className:l,id:c,children:i});R.__docgenInfo={description:`Компонент \`FSelectItem\` — обёртка над \`<option>\`.
