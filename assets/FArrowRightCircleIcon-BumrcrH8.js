import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{e as p}from"./index-B3j06Xw8.js";const a=p.forwardRef(({color:i="primary",size:n=30,st:t,id:l,className:s,handleClick:e,["data-testid"]:o,...d},c)=>r.jsx("svg",{ref:c,width:n,style:t,className:`f-icon ${e?" clicking-icon":""} ${i} ${s||""}`,viewBox:"0 0 16 16",onClick:e,id:l,"data-testid":o,...d,children:r.jsx("path",{"fill-rule":"evenodd",d:"M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"})}));a.displayName="FArrowRightCircleIcon";a.__docgenInfo={description:`Компонент FArrowRightCircleIcon представляет собой SVG иконку стрелки вправо в круге с возможностью настройки цвета, размера и обработки кликов.\r
\r
@function FArrowRightCircleIcon\r
@param {IFArrowRightCircleIcon} props - Пропсы компонента.\r
