import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{F as s}from"./FCloseIcon-DdRZhJBn.js";import{s as n}from"./FDialog-Ccy_5XvS.js";const i=({title:a,handleClose:e})=>r.jsxs("div",{className:n["f-dialog__header"],children:[r.jsx("h3",{className:n["f-dialog__header_title"],children:a}),e&&r.jsx("div",{className:n["f-dialog__header_close"],children:r.jsx(s,{handleClose:e,color:"primary",size:30})})]});i.__docgenInfo={description:`Компонент \`FDialogHeader\` — шапка модального окна с заголовком и кнопкой закрытия.\r
\r
