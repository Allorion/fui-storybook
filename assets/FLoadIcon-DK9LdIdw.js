import{j as r}from"./jsx-runtime-DEdD30eg.js";/* empty css               */import{r as o}from"./index-RYns6xqu.js";const l=({size:e=35,st:i,id:t,className:n,color:s="primary"})=>{const a=o.useRef((Math.random()+1).toString(36).substring(2));return r.jsxs("div",{style:{margin:0,padding:0},children:[r.jsxs("style",{children:[`
