import{j as a}from"./jsx-runtime-Cf8x2fCZ.js";import{F as s}from"./FCloseIcon-ZR3e0z_J.js";import{s as t}from"./FDialog-DLm4K6IN.js";const i=({title:n,handleClose:e})=>a.jsxs("div",{className:t["f-dialog__header"],children:[a.jsx("h3",{className:t["f-dialog__header_title"],children:n}),e&&a.jsx("div",{className:t["f-dialog__header_close"],children:a.jsx(s,{handleClose:e,color:"primary",size:30})})]});i.__docgenInfo={description:`Компонент \`FDialogHeader\` — шапка модального окна с заголовком и кнопкой закрытия.
