import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{e as w}from"./index-B3j06Xw8.js";import{within as G,userEvent as F}from"./index-DH-M5T-F.js";const n=w.forwardRef(({color:s="primary",size:c=30,st:i,id:C,className:h,handleClick:l,["data-testid"]:v,...I},V)=>t.jsx("svg",{ref:V,width:c,viewBox:"0 0 16 16",className:`f-icon ${l?" clicking-icon":""} ${s} ${h||""}`,id:C,onClick:l,style:i,"data-testid":v,...I,children:t.jsx("path",{clipRule:"evenodd",d:"M15.4142 4.41421L6 13.8284L0.585785 8.41421L3.41421 5.58578L6 8.17157L12.5858 1.58578L15.4142 4.41421Z",fillRule:"evenodd"})}));n.displayName="FCheckIcon";n.__docgenInfo={description:`Компонент FCheckIcon представляет собой SVG иконку галочки с возможностью настройки цвета, размера и обработки кликов.\r
\r
