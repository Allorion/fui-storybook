import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./index-B3j06Xw8.js";import{F as _}from"./FButton-Bm7SLZDh.js";import{F as k}from"./FFile-ALKQqT-R.js";const m={"f-button-file":"_f-button-file_7ljnt_1","file-preview-list":"_file-preview-list_7ljnt_1"},P=({children:g,variant:F="contained",color:b="primary",size:w="btn-sm",disabled:p,st:c,className:T,fullWidth:h,id:R,onChange:i,multiple:S=!1,accept:q,direction:x="row",required:C})=>{const l=u.useRef(null),[s,d]=u.useState([]),[B,f]=u.useState({}),y=h?{...c,width:"100%"}:c,N=e=>{if(!e.target.files||e.target.files.length===0)return;const a=Array.from(e.target.files);d(r=>[...r,...a]),i([...a]),a.forEach(r=>{let n=0;const v=setInterval(()=>{n+=10,f(o=>({...o,[r.name]:n})),n>=100&&clearInterval(v)},200)})},j=e=>{d(r=>{const n=r.filter((v,o)=>o!==e);return n.length===0?(i(null),l.current&&(l.current.value="")):i(n),n});const a=s[e].name;f(r=>{const n={...r};return delete n[a],n})};return t.jsxs("div",{className:m["f-button-file"],style:y,children:[t.jsx(_,{variant:F,color:b,size:w,disabled:p,className:T,style:y,id:R,onClick:()=>{var e;return(e=l.current)==null?void 0:e.click()},children:g}),t.jsx("input",{ref:l,type:"file",style:{display:"none"},multiple:S,accept:q,onChange:N,disabled:p,required:C}),s.length>0&&t.jsx("div",{className:m["custom-files-preview"],id:"files",style:{marginTop:"16px"},children:t.jsx("div",{className:m["file-preview-list"],style:{flexDirection:x},children:s.map((e,a)=>t.jsx(k,{name:e.name,size:e.size,handleDelete:()=>j(a),progress:B[e.name]},a))})})]})};P.__docgenInfo={description:`Компонент \`FButtonFile\` — кнопка для выбора файла(ов), которая:\r
