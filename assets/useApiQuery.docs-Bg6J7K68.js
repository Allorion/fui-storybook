...
`,e.jsx("code",{children:"useManualApiQuery"}),")"]})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Таблиц с пагинацией, фильтрацией и сортировкой"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsxs(d.p,{children:["Операций создания, обновления, удаления (используйте"," ",`\r
`,e.jsx("code",{children:"useApiMutation"}),")"]})})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Получения справочников и профиля пользователя"})}),e.jsx("td",{style:{padding:"8px",border:"1px solid #e0e0e0"},children:e.jsx(d.p,{children:"Запросов без кэширования с постоянными побочными эффектами"})})]})]})]}),`
`,e.jsx(d.hr,{}),`
