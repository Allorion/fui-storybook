import{j as a}from"./jsx-runtime-Cf8x2fCZ.js";const o=({color:r="primary",size:n=30,st:i,id:s,className:t,handleClose:e,["data-testid"]:l})=>a.jsx("svg",{width:n,style:i,className:`f-icon ${e?" clicking-icon":""} ${r} ${t||""}`,viewBox:"0 0 16 16",onClick:e,id:s,"data-testid":l,children:a.jsx("path",{d:"M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"})});o.__docgenInfo={description:`Компонент FCloseIcon представляет собой SVG иконку закрытия (крестик) с возможностью настройки цвета, размера и обработки кликов.
