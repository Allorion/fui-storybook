...
import {IFGrid} from '../../../../fui/src/material/interfaces';
import {FGrid} from '../../../../fui/src/material/index';
...
const TemplateDefault: StoryFn<IFGrid> = (args) => (
...
const TemplateCol: StoryFn<IFGrid> = (args) => (
  <FGrid obj={'container'}>
...
const TemplateColAuto: StoryFn<IFGrid> = (args) => (
  <FGrid obj={'container'}>
    <FGrid obj={'item'} sm={2} md={2} lg={2} xl={2} xxl={2}>
      <div className={'item'}>1 of 3</div>
    </FGrid>
