...
const text1 = `import useApi from './useApi';

const MyComponent = () => {
    const { data, loading, error, execute, reset } = useApi<{ message: string }>();
...
export const Default = () => (
    <Fragment>
        <div className="container">
            ...
            <h1>Документация по использованию хука <code>useApi</code></h1>

            <h2>Описание</h2>
            <p>
                <code>useApi</code> — это кастомный React-хук для выполнения API-запросов с использованием <code>axios</code>.
            ...
            <pre>
                <code>
                    {'const {data, loading, error, execute, reset} = useApi<YourDataType>();'}
                </code>
            </pre>
            ...
            <h2>API хука <code>useApi</code></h2>
            <ul>
                <li>
